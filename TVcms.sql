...
--
-- Host: localhost
-- Generation Time: 2020-06-18 21:38:54
-- 服务器版本： 5.6.34
-- PHP Version: 5.5.38
...
CREATE TABLE IF NOT EXISTS `tv_about` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT AUTO_INCREMENT=2 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `tv_admin_role` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT AUTO_INCREMENT=11 ;

--
-- 转存表中的数据 `tv_admin_role`
--
...
CREATE TABLE IF NOT EXISTS `tv_api` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT AUTO_INCREMENT=76 ;
...
(43, '后台登录接口', 'admin/admin/login', '2019-03-01 13:30:24', '2019-03-01 13:30:24', NULL, 1, 'POST', '[{"name":"username"},{"name":"password"}]'),
(44, '获取后台用户对应权限菜单路由', 'admin/menu/getrouter', '2019-03-01 13:30:24', '2019-03-01 13:30:24', NULL, 2, 'GET', '[]'),
(45, '获取网站统计信息', 'admin/webdata/getdata', '2019-03-01 13:30:25', '2019-03-01 13:30:25', NULL, 1, 'GET', '[]'),
(46, '获取系统菜单列表', 'admin/menu/getlist', '2019-03-01 13:30:37', '2019-03-01 13:30:37', NULL, 3, 'GET', '[{"name":"name"},{"name":"page"},{"name":"limit"},{"name":"order"},{"name":"sort"}]'),
(47, '根据类型获取API列表', 'admin/api/getlist', '2019-03-01 13:30:38', '2019-03-01 13:30:38', NULL, 2, 'GET', '[{"name":"type"}]'),
(48, NULL, 'admin/menu/update', '2019-03-02 07:17:06', '2019-03-02 07:17:06', NULL, NULL, NULL, '[]'),
(49, '获取管理员列表', 'admin/admin/getlist', '2019-03-02 08:21:46', '2019-03-02 08:21:46', NULL, 3, 'GET', '[{"name":"name"},{"name":"page"},{"name":"limit"},{"name":"order"},{"name":"sort"}]'),
(50, NULL, 'admin/menu/create', '2019-03-02 08:23:28', '2019-03-02 08:23:28', NULL, NULL, NULL, '[{"name":"father_id"},{"name":"title"},{"name":"path"},{"name":"name"},{"name":"component"},{"name":"sort"},{"name":"icon"},{"name":"api"}]'),
(51, '获取用户列表', 'admin/user/getlist', '2019-03-02 08:56:47', '2019-03-02 08:56:47', NULL, 3, 'GET', '[]'),
(52, '获取角色列表', 'admin/role/getlist', '2019-03-02 08:56:59', '2019-03-02 08:56:59', NULL, 2, 'GET', '[{"name":"name"},{"name":"page"},{"name":"limit"},{"name":"order"},{"name":"sort"}]'),
(53, '获取系统存在的所有菜单', 'admin/menu/getmenu', '2019-03-02 08:57:00', '2019-03-02 08:57:00', NULL, 2, 'GET', '[]'),
(54, NULL, 'blog/article/gettitlelistbypage', '2019-03-02 09:12:21', '2019-03-02 09:12:21', NULL, NULL, NULL, '[{"name":"title"},{"name":"author"},{"name":"tag"},{"name":"page"},{"name":"limit"},{"name":"sort"},{"name":"order"}]'),
(55, NULL, 'blog/neighbors/getall', '2019-03-02 09:12:22', '2019-03-02 09:12:22', NULL, NULL, NULL, '[]'),
(56, '用户注册', 'admin/user/register', '2020-06-07 21:05:05', '2020-06-07 21:05:05', NULL, 1, 'POST', '[{"name":"name"},{"name":"email"},{"name":"password"}]'),
(57, '通过邮箱登录', 'admin/user/login', '2020-06-07 21:05:37', '2020-06-07 21:05:37', NULL, 1, 'POST', '[{"name":"email"},{"name":"password"}]'),
(58, '修改用户名字', 'admin/user/changename', '2020-06-07 21:29:42', '2020-06-07 21:29:42', NULL, 4, 'POST', '[{"name":"id"},{"name":"name"}]'),
(59, '修改用户名字', 'admin/user/changedetail', '2020-06-08 14:33:27', '2020-06-08 14:33:27', NULL, 4, 'POST', '[{"name":"id"},{"name":"address"},{"name":"gender"}]'),
(60, NULL, 'admin/user/changepassword', '2020-06-08 17:51:41', '2020-06-08 17:51:41', NULL, NULL, NULL, '[{"name":"id"},{"name":"password"},{"name":"newpassword"}]'),
(61, NULL, 'blog/tags/getlist', '2020-06-08 19:16:25', '2020-06-08 19:16:25', NULL, NULL, NULL, '[]'),
(62, NULL, 'blog/article/getlist', '2020-06-08 19:29:19', '2020-06-08 19:29:19', NULL, NULL, NULL, '[{"name":"tagID"},{"name":"userID"},{"name":"page"},{"name":"limit"}]'),
(63, NULL, 'blog/comment/getbyarticleid', '2020-06-08 19:41:15', '2020-06-08 19:41:15', NULL, NULL, NULL, '[{"name":"id"}]'),
(64, NULL, 'blog/article/getone', '2020-06-08 19:41:15', '2020-06-08 19:41:15', NULL, NULL, NULL, '[{"name":"ID"}]'),
(65, NULL, 'admin/uploads/determinebase64', '2020-06-09 16:38:15', '2020-06-09 16:38:15', NULL, NULL, NULL, '[{"name":"imgs"},{"name":"path"},{"name":"id"}]'),
(66, NULL, 'blog/article/add', '2020-06-09 16:50:24', '2020-06-09 16:50:24', NULL, NULL, NULL, '[{"name":"a_title"},{"name":"outline"},{"name":"a_content"},{"name":"a_img"},{"name":"tag_id"},{"name":"imgs"},{"name":"id"}]'),
(67, NULL, 'blog/article/gettitlelist', '2020-06-10 14:53:25', '2020-06-10 14:53:25', NULL, NULL, NULL, '[]'),
(68, NULL, 'blog/imgupload/addimg', '2020-06-11 19:17:47', '2020-06-11 19:17:47', NULL, NULL, NULL, '[{"name":"a_title"},{"name":"outline"},{"name":"a_content"},{"name":"a_img"},{"name":"tag_id"},{"name":"imgs"},{"name":"id"}]'),
(69, NULL, 'blog/imgupload/getlist', '2020-06-12 15:58:27', '2020-06-12 15:58:27', NULL, NULL, NULL, '[{"name":"tagID"},{"name":"userID"},{"name":"page"},{"name":"limit"}]'),
(70, NULL, 'blog/imgupload/getone', '2020-06-12 18:18:00', '2020-06-12 18:18:00', NULL, NULL, NULL, '[{"name":"ID"}]'),
(71, NULL, 'blog/webdata/addpraise', '2020-06-12 18:28:09', '2020-06-12 18:28:09', NULL, NULL, NULL, '[{"name":"id"}]'),
(72, NULL, 'blog/follow/addwatch', '2020-06-17 16:55:08', '2020-06-17 16:55:08', NULL, NULL, NULL, '[{"name":"user_id"},{"name":"followed_userid"}]'),
(73, NULL, 'blog/article/del', '2020-06-18 06:59:08', '2020-06-18 06:59:08', NULL, NULL, NULL, '[{"name":"id"}]'),
(74, NULL, 'blog/imgupload/getimgtitlelist', '2020-06-18 07:31:58', '2020-06-18 07:31:58', NULL, NULL, NULL, '[{"name":"id"}]'),
(75, NULL, 'blog/imgupload/del', '2020-06-18 08:04:53', '2020-06-18 08:04:53', NULL, NULL, NULL, '[{"name":"id"}]');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT AUTO_INCREMENT=85 ;
...
(82, 0, 1, '边泉', 'fadfa打发打发', '0000-00-00 00:00:00', 0, 0, 0, 0, '2019-02-11 07:29:58', NULL),
(83, 0, 1, '边泉', '发打发打发', '2019-02-11 07:31:13', 0, 0, 0, 0, '2019-02-11 07:31:13', NULL),
(84, 17, 0, '方方达', '大的事发后暗示法', '2019-02-18 13:32:50', 0, 0, 0, 0, '2019-02-18 13:32:50', NULL);
...
(1, 'user_register_status', '1', '2019-02-11 10:14:28', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 'blog_article_status', '1', '2019-02-11 10:14:47', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, 'blog_comment_status', '1', '2019-02-11 10:14:57', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `tv_follow` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL,
  `followed_user` int(10) NOT NULL,
...
INSERT INTO `tv_follow` (`id`, `user_id`, `followed_user`, `status`, `create_time`, `update_time`, `delete_time`) VALUES
(1, 43, 43, 0, '2020-06-17 16:55:08', '2020-06-17 16:55:08', '0000-00-00 00:00:00'),
(2, 43, 1, 0, '2020-06-17 16:55:24', '2020-06-17 16:55:24', '0000-00-00 00:00:00'),
(3, 43, 1, 0, '2020-06-17 18:17:33', '2020-06-17 18:17:33', '0000-00-00 00:00:00'),
(4, 43, 1, 0, '2020-06-17 18:17:37', '2020-06-17 18:17:37', '0000-00-00 00:00:00'),
(5, 43, 43, 0, '2020-06-18 13:35:05', '2020-06-18 13:35:05', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `tv_images` (
  ...
  `delete_time` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT AUTO_INCREMENT=132 ;
...
(107, '1551096208eYilP.jpeg', 'user/1/article', 1, 1, '2019-02-25 12:03:31', '2019-02-25 12:03:31', NULL),
(108, '1551096208gMybS.jpeg', 'user/1/article', 1, 1, '2019-02-25 12:03:31', '2019-02-25 12:03:31', NULL),
(109, '1591721165mXAoL.jpeg', 'user/43/article', 43, 1, '2020-06-09 16:50:24', '2020-06-09 16:50:24', NULL),
(110, '15917218926J32i.jpeg', 'user/43/article', 43, 1, '2020-06-09 16:58:29', '2020-06-09 16:58:29', NULL),
(111, '1591773094xnF11.jpeg', 'user/43/article', 43, 1, '2020-06-10 07:11:35', '2020-06-10 07:11:35', NULL),
(112, '1591798643v9po9.jpeg', 'user/43/article', 43, 1, '2020-06-10 14:17:25', '2020-06-10 14:17:25', NULL),
(113, '1591798675bne5C.jpeg', 'user/43/article', 43, 1, '2020-06-10 14:17:56', '2020-06-10 14:17:56', NULL),
(114, '1591798697mxai4.jpeg', 'user/43/article', 43, 1, '2020-06-10 14:18:24', '2020-06-10 14:18:24', NULL),
(115, '1591800354GVlJI.jpeg', 'user/43/article', 43, 1, '2020-06-10 14:45:56', '2020-06-10 14:45:56', NULL),
(116, '1591800402sFdav.jpeg', 'user/43/article', 43, 1, '2020-06-10 14:46:43', '2020-06-10 14:46:43', NULL),
(117, '1591800466VHQdB.jpeg', 'user/43/article', 43, 1, '2020-06-10 14:47:48', '2020-06-10 14:47:48', NULL),
(118, '159180080370U3W.jpeg', 'user/43/article', 43, 1, '2020-06-10 14:53:25', '2020-06-10 14:53:25', NULL),
(119, '1591814635WkMVD.jpeg', 'user/1/article', 1, 1, '2020-06-10 18:43:59', '2020-06-10 18:43:59', NULL),
(120, '1591821837TYvIN.jpeg', 'user/43/article', 43, 1, '2020-06-10 20:43:59', '2020-06-10 20:43:59', NULL),
(121, '1591850574PRK8J.jpeg', '', 43, 1, '2020-06-11 19:17:47', '2020-06-11 19:17:47', NULL),
(122, '1591903057l6xqy.jpeg', '', 43, 1, '2020-06-11 19:17:47', '2020-06-11 19:17:47', NULL),
(123, '15919065054kAJQ.jpeg', '', 43, 1, '2020-06-11 20:15:12', '2020-06-11 20:15:12', NULL),
(124, '1591986158NVNPw.jpeg', '', 43, 1, '2020-06-12 18:22:51', '2020-06-12 18:22:51', NULL),
(125, '1591986158vBvZl.jpeg', '', 43, 1, '2020-06-12 18:22:51', '2020-06-12 18:22:51', NULL),
(126, '1591990497YMGfp.jpeg', '', 43, 1, '2020-06-12 19:35:10', '2020-06-12 19:35:10', NULL),
(127, '1591990855HBaTX.jpeg', '', 43, 1, '2020-06-12 19:40:59', '2020-06-12 19:40:59', NULL),
(128, '1592475492d68hp.jpeg', '', 43, 1, '2020-06-18 10:19:58', '2020-06-18 10:19:58', NULL),
(129, '1592475817DwOee.jpeg', '', 43, 1, '2020-06-18 10:23:43', '2020-06-18 10:23:43', NULL),
(130, '15924761154YiHS.jpeg', '', 43, 1, '2020-06-18 10:28:39', '2020-06-18 10:28:39', NULL),
(131, '1592476373mUez9.jpeg', '', 43, 1, '2020-06-18 10:32:56', '2020-06-18 10:32:56', NULL);

-- --------------------------------------------------------

--
-- 表的结构 `tv_images_source`
--

CREATE TABLE IF NOT EXISTS `tv_images_source` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT AUTO_INCREMENT=36 ;

--
-- 转存表中的数据 `tv_images_source`
--

INSERT INTO `tv_images_source` (`id`, `image_id`, `table_name`, `table_id`, `create_time`, `update_time`, `delete_time`) VALUES
(11, 107, 'article', 17, '2019-02-25 12:03:31', '2019-02-25 12:03:31', NULL),
(12, 108, 'article', 17, '2019-02-25 12:03:31', '2019-02-25 12:03:31', NULL),
(13, 109, 'article', 20, '2020-06-09 16:50:24', '2020-06-09 16:50:24', NULL),
(14, 110, 'article', 21, '2020-06-09 16:58:29', '2020-06-09 16:58:29', NULL),
(15, 111, 'article', 22, '2020-06-10 07:11:35', '2020-06-10 07:11:35', NULL),
(16, 112, 'article', 23, '2020-06-10 14:17:25', '2020-06-10 14:17:25', NULL),
(17, 113, 'article', 24, '2020-06-10 14:17:56', '2020-06-10 14:17:56', NULL),
(18, 114, 'article', 25, '2020-06-10 14:18:24', '2020-06-10 14:18:24', NULL),
(19, 115, 'article', 26, '2020-06-10 14:45:56', '2020-06-10 14:45:56', NULL),
(20, 116, 'article', 27, '2020-06-10 14:46:43', '2020-06-10 14:46:43', NULL),
(21, 117, 'article', 28, '2020-06-10 14:47:48', '2020-06-10 14:47:48', NULL),
(22, 118, 'article', 29, '2020-06-10 14:53:25', '2020-06-10 14:53:25', NULL),
(23, 119, 'article', 31, '2020-06-10 18:43:59', '2020-06-10 18:43:59', NULL),
(24, 120, 'article', 32, '2020-06-10 20:43:59', '2020-06-10 20:43:59', NULL),
(25, 121, 'Imgupload', 3, '2020-06-11 19:17:47', '2020-06-11 19:17:47', NULL),
(26, 122, 'Imgupload', 3, '2020-06-11 19:17:47', '2020-06-11 19:17:47', NULL),
(27, 123, 'Imgupload', 4, '2020-06-11 20:15:12', '2020-06-11 20:15:12', NULL),
(28, 124, 'Imgupload', 5, '2020-06-12 18:22:51', '2020-06-12 18:22:51', NULL),
(29, 125, 'Imgupload', 5, '2020-06-12 18:22:51', '2020-06-12 18:22:51', NULL),
(30, 126, 'Imgupload', 6, '2020-06-12 19:35:10', '2020-06-12 19:35:10', NULL),
(31, 127, 'Imgupload', 7, '2020-06-12 19:40:59', '2020-06-12 19:40:59', NULL),
(32, 128, 'Imgupload', 9, '2020-06-18 10:19:58', '2020-06-18 10:19:58', NULL),
(33, 129, 'Imgupload', 10, '2020-06-18 10:23:43', '2020-06-18 10:23:43', NULL),
(34, 130, 'Imgupload', 11, '2020-06-18 10:28:39', '2020-06-18 10:28:39', NULL),
(35, 131, 'Imgupload', 12, '2020-06-18 10:32:56', '2020-06-18 10:32:56', NULL);
...
CREATE TABLE IF NOT EXISTS `tv_imgupload` (
  `i_id` int(6) NOT NULL AUTO_INCREMENT,
  `i_title` varchar(30) CHARACTER SET utf8 NOT NULL,
  `i_content` text CHARACTER SET utf8 NOT NULL,
  `create_time` timestamp NULL DEFAULT NULL,
  `i_img` text NOT NULL,
  `published` int(6) NOT NULL,
  `comment_num` int(6) NOT NULL,
  `praise_num` int(6) NOT NULL,
  `viewer_num` int(6) NOT NULL,
...
--
-- 转存表中的数据 `tv_imgupload`
--

INSERT INTO `tv_imgupload` (`i_id`, `i_title`, `i_content`, `create_time`, `i_img`, `published`, `comment_num`, `praise_num`, `viewer_num`, `user_id`, `tag_id`, `update_time`, `delete_time`, `outline`, `status`) VALUES
(3, '1231', '', '2020-06-11 19:17:47', 'http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1591903057l6xqy.jpeg', 0, 0, 0, 0, 43, 1, '2020-06-11 19:17:47', NULL, '123123', NULL),
(4, '123', '', '2020-06-11 20:15:12', 'http://localhost:8888/TVcms/servers/public/uploads/user/43/article/15919065054kAJQ.jpeg', 0, 0, 0, 0, 43, 1, '2020-06-11 20:15:12', NULL, '1222', NULL),
(5, '第一', '![](http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1591986158NVNPw.jpeg)![](http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1591986158vBvZl.jpeg)', '2020-06-12 18:22:51', 'http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1591986158vBvZl.jpeg', 0, 0, 0, 0, 43, 1, '2020-06-18 08:05:01', '2020-06-18 08:05:01', '0', NULL),
(6, '第二', '', '2020-06-12 19:35:10', 'http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1591990497YMGfp.jpeg', 0, 0, 0, 0, 43, 1, '2020-06-12 19:35:10', NULL, '0', NULL),
(7, '333', '![](http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1591990855HBaTX.jpeg)', '2020-06-12 19:40:59', 'http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1591990855HBaTX.jpeg', 0, 0, 0, 0, 43, 1, '2020-06-18 08:04:53', '2020-06-18 08:04:53', '1231222', NULL),
(9, '无题', '', '2020-06-18 10:19:58', 'http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1592475492d68hp.jpeg', 0, 0, 0, 0, 43, 1, '2020-06-18 10:19:58', NULL, '精灵世界', NULL),
(10, '无题', '![](http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1592475817DwOee.jpeg)', '2020-06-18 10:23:43', 'http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1592475817DwOee.jpeg', 0, 0, 0, 0, 43, 1, '2020-06-18 10:23:43', NULL, '小精灵', NULL),
(11, '地铁', '![](http://localhost:8888/TVcms/servers/public/uploads/user/43/article/15924761154YiHS.jpeg)', '2020-06-18 10:28:39', 'http://localhost:8888/TVcms/servers/public/uploads/user/43/article/15924761154YiHS.jpeg', 0, 0, 0, 0, 43, 1, '2020-06-18 10:28:39', NULL, '地铁', NULL),
(12, '绿', '![](http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1592476373mUez9.jpeg)', '2020-06-18 10:32:56', 'http://localhost:8888/TVcms/servers/public/uploads/user/43/article/1592476373mUez9.jpeg', 0, 0, 0, 0, 43, 1, '2020-06-18 10:32:56', NULL, '绿色', NULL);
...
CREATE TABLE IF NOT EXISTS `tv_menu_api` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT AUTO_INCREMENT=47 ;
...
CREATE TABLE IF NOT EXISTS `tv_neighbors` (
...
CREATE TABLE IF NOT EXISTS `tv_role` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT AUTO_INCREMENT=7 ;
...
CREATE TABLE IF NOT EXISTS `tv_role_menu` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT AUTO_INCREMENT=31 ;

--
-- 转存表中的数据 `tv_role_menu`
--
...
(29, 1, 11, '2019-02-25 12:21:58', '2019-02-25 12:21:58', NULL),
(30, 1, 12, '2019-02-25 12:21:58', '2019-02-25 12:21:58', NULL);
...
CREATE TABLE IF NOT EXISTS `tv_system_menu` (
...
(5, '管理员管理', 4, NULL, '2019-03-02 08:20:56', NULL, 'admin', 'auth/admin', '', 'admin', 0),
(6, '角色管理', 4, NULL, '2019-03-02 08:35:03', NULL, 'role', 'auth/role', '', 'role', 2),
(7, '菜单管理', 4, NULL, '2019-03-02 08:57:40', NULL, 'menu', 'auth/menu', '', 'menu', 3),
(8, '接口管理', 4, NULL, '2019-03-02 08:57:27', NULL, 'api', 'auth/api', '', 'api', 4),
(9, '系统管理', 0, NULL, '2019-03-02 08:36:48', NULL, '/system', 'layout/Layout', 'chart', 'system', 20),
...
(1, '漫画临摹', NULL, NULL, NULL),
(2, '原创作品', NULL, NULL, NULL),
(3, '漫友闲聊', NULL, NULL, NULL),
(4, '需求发布', NULL, NULL, NULL);
...
INSERT INTO `tv_user` (`user_id`, `user_name`, `user_pwd`, `user_email`, `user_status`, `user_pwd_salt`, `introduction`, `update_time`, `create_time`, `delete_time`, `user_mobile`, `gender`, `birthday`, `user_address`, `user_level`, `user_avatar`) VALUES
(1, '边泉', 'e7d66c8b123ffad09aa180a9531b6f82', '920200256@qq.com', '1', 'eNHm0hMygWF8ggQU0sW6qpusGIo2rxWj', '打发吃的是草', '2018-03-31 16:00:00', NULL, NULL, 2147483647, 1, NULL, NULL, 1, 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif'),
(36, '边泉111', 'b38ed29006731b720b50732a94423ac7', '9202002516@qq.com', '0', 'CDgFwnvzCuoDdr35cd3ESgvy6yYueyBG', '', NULL, NULL, NULL, NULL, 2, NULL, NULL, 0, NULL),
(37, '边泉1111', '6f47e37ec8c63c49a793f12c73259125', '92020025116@qq.com', '0', 'YKYWYH3OExillINMVc8OHsqFwtf5KHIf', '', NULL, NULL, NULL, NULL, 3, NULL, NULL, 0, NULL),
(38, '边泉1111对方', 'c79e4cdca5b2704fbcaa9556dbba4269', '9202002511的6@qq.com', '0', 'PmbJUx6zb5GzZt2X8GIt0aRiqT1aKlkj', '', NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL),
(39, '的道法', 'f1d7150365f0402c783202a716d3f601', '920200@qq.com', '0', 'asT0mREOe7Ah7JLERFOCPmMqQOiLftrR', '', NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL),
(40, '测试用户了', '4d87a8155b62270c710dfeed718789f1', '920@qq.com', '0', '5xM6n0dhYtqgdoxgWL6Zv2fGKby10F6g', '', NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL),
(41, 'dfadsf', 'b46c1e4b6fac23c29723c0937a8e1262', '1234@qq.com', '0', '4XJBVdXEdp8Qt7N9m5xwQQwyf5VcQWGx', '', '2019-02-17 13:04:31', '0000-00-00 00:00:00', NULL, NULL, 0, NULL, NULL, 0, NULL),
(42, '打发打发', 'e7d66c8b123ffad09aa180a9531b6f82', '92012556@qq.com', '0', 'eNHm0hMygWF8ggQU0sW6qpusGIo2rxWj', '', '2019-02-21 08:44:38', '0000-00-00 00:00:00', NULL, NULL, 0, NULL, NULL, 0, NULL),
(43, '木子三石', 'f1e4c3648ac9a33d0dd2c83d3cdeca81', '515738252@qq.com', '0', 'zyQ9VpnrG5i6ZGfbYiRGjY06Xu7Cr63q', '', '2020-06-18 10:15:39', '0000-00-00 00:00:00', NULL, NULL, 3, NULL, '123312', 1, 'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png');
...
CREATE TABLE IF NOT EXISTS `tv_web_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `delete_time` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=FIXED AUTO_INCREMENT=2 ;
...
(1, 17, 18, 47, 23201, 0, 0, NULL, NULL, NULL);
