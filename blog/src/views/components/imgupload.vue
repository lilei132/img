...
<el-row class="sidepadding">
        ...
        <el-row class="sidepadding2">
          <div class="imgBox">
            <div class="imgContainer background-box" style="width:148px">
...
import { getOne, addArticle, updateArticle,addImg } from '@/api/article'
...
export default {
  ...
  methods: {
    ...
    addArticle() {
      ...
      addImg(this.article).then(response => {
